        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="relative overflow-hidden transition-all duration-300 transform bg-white border shadow-sm group border-slate-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
            ...
            <div className="relative p-6">
              ...
              <div>
                <h2 className="mb-1 text-sm font-semibold tracking-wide uppercase text-slate-500">Total Users</h2>
                <p className="mb-2 text-3xl font-bold text-slate-800">{stats.users}</p>
                <p className="text-sm text-slate-600">Students and staff</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden transition-all duration-300 transform bg-white border shadow-sm group border-slate-200 rounded-2xl hover:shadow-lg hover:-translate-y-1">
            ...
            <div className="relative p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center justify-center w-12 h-12 transition-colors bg-red-100 rounded-xl group-hover:bg-red-200">
              ...
              <div>
                <h2 className="mb-1 text-sm font-semibold tracking-wide uppercase text-slate-500">Inactive Academies</h2>
                <p className="mb-2 text-3xl font-bold text-slate-800">{stats.inactiveAcademies}</p>
